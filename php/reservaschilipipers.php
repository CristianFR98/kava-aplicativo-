...
class reservaschili{
    ...
    public function insertarUsuario($nombre, $telefono, $fecha, $Hora, $Cantidadpersonas) {
        try {
            $san = "INSERT INTO `reservas` (`nombre`,`id_restaurantes`, `telefono`, `fecha`, `hora`, `numerodepersonas`) VALUES ('$nombre','14', '$telefono', '$fecha', '$Hora', '$Cantidadpersonas')";
...
$gestorInsercion = new reservaschili($conex->conn);
